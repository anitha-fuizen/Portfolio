  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage:{
        ...
        hero_shape2_dark:'url(/hero/shape-dark.svg)',
        about_shape_light:'url(/about/shape-light.svg)',
        about_shape_dark:'url(/about/shape-dark.svg)',
        dots_light:'url(/about/dots-dark.svg)',
        dots_dark:'url(/about/dots-light.svg)',
        work_dark:'url(/work/project-bg-dark.png)',
         work_light:'url(/work/project-bg-light.png)',
